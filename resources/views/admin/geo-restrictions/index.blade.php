...
@section('title', 'Geo Restrictions')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8 flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-gh-text">Geo Restrictions</h1>
        </div>
        <a href="{{ route('admin.geo-restrictions.create') }}" 
    ...
    <div class="bg-gh-bg-secondary border border-gh-border rounded-lg p-6">
        <p class="text-gh-text-muted">Manage Geo Restrictions</p>
